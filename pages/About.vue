...
<template>
    ...
    >
      ...
      <div class="px-8 text-center flex flex-col gap-10">
        <h2 class="text-[50px]  mb-10 font-cairo  ">Our Services</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div class="bg-[#eceaea]  bg-opacity-90 p-10 rounded-2xl shadow">
            <h3 class="font-bold mb-2 text-[#26103d]">Same-Day Delivery</h3>
            <p class="text-[#26103d]">Offer same-day delivery for last-minute orders, ensuring customers can send flowers quickly.</p>
          </div>
          <div class="bg-[#eceaea] bg-opacity-90 p-6 rounded-lg shadow">
            <h3 class="font-bold mb-2 text-[#26103d]">Custom Bouquets</h3>
            <p class="text-[#26103d]">Allow customers to design their own bouquets by choosing specific flowers and arrangements.</p>
          </div>
          <div class="bg-[#eceaea] bg-opacity-90 p-6 rounded-lg shadow">
            <h3 class="font-bold mb-2 text-[#26103d]">Seasonal Promotions</h3>
            <p class="text-[#26103d]">Run seasonal promotions and special offers, such as discounts for Valentine's Day, Mother's Day, and holidays.</p>
          </div>
          <div class="bg-[#eceaea] bg-opacity-90 p-6 rounded-lg shadow">
            <h3 class="font-bold mb-2 text-[#26103d]">Flower Care Tips</h3>
            <p class="text-[#26103d]">Provide care instructions and tips for maintaining flower arrangements, enhancing customer experience.</p>
          </div>
        </div>
      </div>
