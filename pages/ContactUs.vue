...
<div class="relative w-full min-h-screen bg-[url('../assets/about-us-cover.png')] bg-cover bg-center">
      
      
      <div class="absolute inset-0 bg-slate-900 bg-opacity-35 z-0"></div>
       
       <img src="../assets/Rectangle.png" alt="Rectangle" class="absolute inset-0 top-[300px]    z-0" />

    <div class="w-full absolute inset-0 top-20 flex flex-col justify-center items-center gap-5">
        <h1 class="text-indigo-950 text-5xl font-semibolde font-cairo"> Contact Us</h1>
        <p class="text-indigo-950 font-normal text-lg font-cairo w-[800px] text-center">We love hearing from our customers! If you have any questions, suggestions, or feedback, Please feel free to get in touch.</p>
        ...
        <div class="flex justify-evenly items-center w-full"> 
            ...
            <div class="bg-zinc-300  w-full  p-6 rounded-s-3xl rounded-t-3xl shadow-lg mt-6 max-w-md relative pl-10">
                <h2 class="text-3xl font-semibold text-indigo-950 font-cairo">Get in Touch!</h2>
                   <div class="flex flex-col">
                        ...
                        <textarea 
                            ...
                            class="w-full h-32 bg-transparent border-b-2 border-white text-white text-lg font-cairo focus:outline-none resize-none"
                        ></textarea>
