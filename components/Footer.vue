  ...
  <img src="../assets/footer-logo.png" alt="footer-logo" class="w-20 h-16">
       ...
       <div class="flex flex-col gap-4">
        ...
        <div class="relative flex flex-row">
         <input type="text" placeholder="Enter Your Email" class=" pl-5 pr-7 w-[280px] h-10 border-2 border-indigo-900 rounded-s-2xl px-2">
         <button class="absolute right-0 w-40 h-10 bg-indigo-950 text-white rounded-e-2xl  ">Send</button>
        </div>
      </div>
