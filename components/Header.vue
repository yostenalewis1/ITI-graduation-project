          ...
          <div class="w-40 inline-flex justify-between items-end">
                   ...
                   >
                      <svg 
                          :class="{
                            ...
                            'text-indigo-900': $route.path !== '/'
                          }" 
                          width="28" height="28" viewBox="0 0 31 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  ...
                  >
                      <svg 
                          :class="{
                            'text-white': $route.path === '/', 
                            'text-indigo-900': $route.path !== '/ShoppingCart'
                          }" 
                          width="28" height="28" viewBox="0 0 31 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
